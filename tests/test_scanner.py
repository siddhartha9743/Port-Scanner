...
def test_cli_view_history_limit_empty_history(tmp_path, capsys):
    from src.main import main
    import sys
...
def test_cli_view_history_limit_exact_history_size(tmp_path, capsys):
    ...
    assert "10.0.0.2" in captured.out
    assert "10.0.0.3" in captured.out


def test_cli_view_history_limit_smaller_than_history(tmp_path, capsys):
    from src.main import main
    import json
    import sys
    ...
    assert "192.168.10.1" not in captured.out
    assert "192.168.10.2" not in captured.out
    assert "192.168.10.3" in captured.out
    assert "192.168.10.4" in captured.out

def test_cli_view_history_limit_json_format(tmp_path, capsys):
    from src.main import main
    import json
    import sys
    ...
    assert "10.20.0.1" not in captured.out
    assert "10.20.0.2" in captured.out
    assert "10.20.0.3" in captured.out


def test_cli_view_history_limit_one_returns_latest_record(tmp_path, capsys):
    from src.main import main
    import json
    import sys
    ...
    assert "172.16.0.1" not in captured.out
    assert "172.16.0.2" in captured.out


def test_cli_view_history_limit_preserves_record_order(tmp_path, capsys):
    from src.main import main
    import json
    import sys
    ...
    assert "192.0.2.1" not in captured.out
    assert "192.0.2.2" in captured.out
...
def test_cli_view_history_limit_non_integer(tmp_path, capsys):
    from src.main import main
    import sys
...
def test_cli_view_history_limit_float_rejected(tmp_path, capsys):
    from src.main import main
    import sys
...
def test_cli_view_history_limit_decimal_string_rejected(tmp_path, capsys):
    from src.main import main
    import sys
